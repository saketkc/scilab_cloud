...
function gateway_filename = ilib_gen_gateway(name,tables)
  ...
  for itable = 1:L
    ...
    t = [ '#include <mex.h> ';
          ...
          '{';
          '  Rhs = Max(0, Rhs);';
          '  if (*(OverloadTab[Fin-1].f) != NULL) '
          '  {';
          '     if(pvApiCtx == NULL)';
          '     {'
          '       pvApiCtx = (StrCtx*)MALLOC(sizeof(StrCtx));';
          '     }';
          '     pvApiCtx->pstName = (char*)OverloadTab[Fin-1].name;';
          '    (*(OverloadTab[Fin-1].f))(OverloadTab[Fin-1].name,OverloadTab[Fin-1].F);';
          '  }';
          '  return 0;';
          '}'];
