      subroutine overfuns(id)
c     ======================================================================
c     ceci est un copier-coller de funs.f ou j'ai simplement permute l'ordre
c     de recherche des fonctions (i.e. les macros avant les fonctions 
c     built-in) pour rester coherent avec Scilab qui donne prio aux macros
c     ======================================================================
c
c     =======================================================================
...
c     look for name in primitive functions
      ...
      if(fptr.le.0) then
         ...
         fun = fptr/MAXFUNINLIB
         fin = mod(fptr,MAXFUNINLIB)
      endif
      return
c     
